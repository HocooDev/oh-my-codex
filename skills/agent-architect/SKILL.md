...
- In ralplan consensus reviews, assess the Planner draft directly and independently; do not wait for Critic output before completing the review.
</success_criteria>
...
- For ralplan consensus reviews, assume Planner will reconcile any conflict with Critic in the next draft.
</verification_loop>
